"""
*************** Mailer
* Import den med 'from LK_emailer import Mailer'
* Opret et Mailer-objekt med 'mailer = Mailer()'
* Send en e-mail med 'mailer.sendmail(subject, tos, text, html, filename)'
"""
...
class Mailer:
    ...
    def sendmail(self, subject: str, tos: list = None, text: str = None, html: str = None, filename: str = None, bcc: list = None):
        """
        ...
        bcc : list, valgfri
            En liste over BCC (blind carbon copy) modtagere.
        """
    ...
    def __send(self, msg):
        ...
        # Prepare all recipients (visible and BCC)
        all_recipients = self.tos or [self.__args['sender']]
        if self.bcc:
            all_recipients.extend(self.bcc)
        self.server.sendmail(self.__sender_email, all_recipients, self.msg.as_string())
        self.server.close()
